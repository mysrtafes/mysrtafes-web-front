      ...
      <div className={styles.main}>
            <div className={styles.inner}>
                ...
                <div className={styles.p}>
                    <strong>『チャレンジダンジョン！～不思議のダンジョンRTAフェス外伝～』(略称：チャレダン)</strong>は、不思議のダンジョンRTAフェスが主催する「期間内にゲームに挑戦して目標達成を目指す」イベントです。<br /><br />
                    挑戦するゲームは不思議のダンジョン・ローグライクジャンルとされているものであれば何でもOKです。<br /><br />
                    日本国内では他にも<strong>『RTAハッカソン』『Deep Running』</strong>などのRTAに挑戦するイベントが開催されていますが、本イベントでは「RTA以外の挑戦」も歓迎します。<br /><br />
                    <strong>「ちょっと不思議部門」</strong>は各作品・ダンジョンのクリアが目標になります。<br />
                    <strong>「もっと不思議部門」</strong>はRTAやスコアアタック、高難易度ダンジョンや縛りプレイなど、やりこみクリアを目標にして頂きます。<br /><br />
